...
class CustomLayouts:
    def __init__(self):
        self.dimensions = {'title' : {'type': 1, 'left': 0.5, 'top': 0.3, 'width': 9, 'height': 1.25},
                           'footer': [{'type' : 1, 'left': 0.5, 'top': 7, 'width': 3, 'height': 0.5}, {'type' : 2, 'left': 3.5, 'top': 7, 'width': 3, 'height': 0.5}, {'type' : 3, 'left': 6.5, 'top': 7, 'width': 3, 'height': 0.5}]}
    ...
    def get_layout_dimensions(self, layout_id):
        match layout_id:
            ...
            ## Only Title
            case 0:
                self.dimensions['title'] = {'type': 0, 'left': 0.5, 'top': 2, 'width': 9, 'height': 1.25}
            ...
            case 2:
                self.dimensions['body'] = [{'type': 1, 'left': 0.5, 'top': 2, 'width': 4.5, 'height': 4.5}, {'type': 1, 'left': 5, 'top': 2, 'width': 4.5, 'height': 4.5}]
            ...
            case 4:
                self.dimensions['body'] = [{'type' : 3, 'left': 0.5, 'top': 2, 'width': 3, 'height': 4.5}, {'type' : 3, 'left': 3.5, 'top': 2, 'width': 3, 'height': 4.5}, {'type' : 3, 'left': 6.5, 'top': 2, 'width': 3, 'height': 4.5}]
            case 5: 
